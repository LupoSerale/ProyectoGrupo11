                                            ...
                                            <table className="table table-bordered table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>7000</td>
                                                        <td>Disponible</td>
                                                        <td align="center"><Link to="#" className="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#verModal"><i className="fa fa-eye fa-lg"></i></Link></td>
                                                        <td align="center"><Link to="/editarProducto" className="btn btn-sm btn-outline-secondary"><i className="fa fa-pencil fa-lg"></i></Link></td>
                                                        <td align="center"><Link to="#" className="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#eliminarModal"><i className="fa fa-trash fa-lg"></i></Link>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
